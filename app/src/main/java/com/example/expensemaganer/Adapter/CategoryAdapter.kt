...
import com.example.expensemaganer.DataDisplayActivity
import com.example.expensemaganer.Model.Model
import com.example.expensemaganer.R

class CategoryAdapter(var dataDisplayActivity: DataDisplayActivity, var categorylist: ArrayList<Model>) : BaseAdapter()
{
